...
export const SYSTEM =
  ...
  "short name. The kinds are fissure, invasion, alert, baro, sortie, archonHunt, cycle, nightwave, bounty and " +
  "reset. A cycle rule takes leadMinutes when the user wants warning before the state begins, a bounty rule " +
  "takes syndicates, the board level 1 to 5 and mission types, and a reset rule is daily or weekly.";
