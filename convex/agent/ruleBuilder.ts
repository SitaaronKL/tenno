...
export const SYSTEM =
  ...
  "archimedea and reset. A cycle rule takes leadMinutes when the user wants warning before the state begins, " +
  "a bounty rule takes syndicates, the board level 1 to 5 and mission types, an archimedea rule takes the " +
  "variant deep or temporal plus deviations and risks, and a reset rule is daily or weekly.";
