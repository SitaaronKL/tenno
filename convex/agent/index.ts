...
export const tenno = new Agent(agentComponent, {
  ...
  instructions:
    ...
    "the user's notification rules, draftBuild when they want a loadout for a frame or weapon. Confirm a rule " +
    "with the user before you create it. Times are unix ms, say " +
